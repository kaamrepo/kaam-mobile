    ...
    const postRequest = async (data) => {
      try {
        ...
        if (requestType === 'postingrequest') {
          ...
          data['prevjobpostingcount'] = loggedInUser?.allowedjobposting || 0;
        } else {
          data['requestjobapplicationcount'] = data?.requestnumberofapplication || 0;
          data['prevjobapplicationcount'] = loggedInUser?.allowedjobapplication || 0;
        }
    ...
    return (
      <SafeAreaView style={tw`flex-1 px-5 py-2 bg-white dark:bg-gray-950`}>
        ...
        >
          ...
          >
            Looks like you have finished your initial counts, Let's raise
            a request to get some more!
          </Text>
            ...
            <>
              <View style={tw`w-full flex-row gap-2 mt-4`}>
                <View style={tw`flex-1`}>
                  ...
                  <TextInput
                    value={loggedInUser?.allowedjobposting?.toString() || '0'}
                    editable={false}
                    style={[
                      { fontFamily: 'Poppins-Regular' },
                      tw`text-black dark:text-white text-[14px] px-4 py-2 border-[1px] w-full rounded-lg`,
            ...
            <>
              <View style={tw`w-full flex-row gap-2 mt-4`}>
                <View style={tw`flex-1`}>
                  ...
                  <TextInput
                    value={loggedInUser?.allowedjobapplication?.toString() || '0'}
                    editable={false}
                    style={[
                      { fontFamily: 'Poppins-Regular' },
                      tw`text-black dark:text-white text-[14px] px-4 py-2 border-[1px] w-full rounded-lg`,
