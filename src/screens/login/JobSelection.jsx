  ...
  const jobTypes = [
    {
      ...
      icon: require('../../assets/images/part-time.png'),
      name: 'Part-Time',
      isSelected: false,
    },
    {
      ...
      isIcon: false,
      type: Icons.MaterialCommunityIcons,
      icon: require('../../assets/images/full-time.png'),
      name: 'Full-Time',
      isSelected: false,
    },
    {
    ...
    },
    {
      ...
      isIcon: false,
      type: Icons.MaterialCommunityIcons,
      icon: require('../../assets/images/internship.png'),
      name: 'Internship',
      isSelected: false,
    },
    {
    ...
    <SafeAreaView style={[tw` flex-1 justify-between px-4 pt-[10%]`]}>
      <View style={[tw`gap-3 justify-evenly`]}>
        <View style={tw`items-center`}>
          <Image
            source={require('../../assets/images/kaam-logo.png')}
            style={{
              height: 35,
              width: 20,
            }}
        ...
        <View>
          <Text
            style={[tw`text-2xl text-black`, {fontFamily: 'Poppins-SemiBold'}]}>
    ...
    <Pressable
      style={({pressed}) => [
        tw`flex-row items-center justify-between ${
          pressed ? 'bg-slate-300/50' : 'bg-white'
        } px-7 py-3 rounded-lg mx-2 mb-2 `,
      ]}
      onPress={onSelect}>
      <View style={[tw`flex-row items-center gap-4`]}>
        {object.isIcon ? (
          <Icon type={object.type} name={object.icon} color={'#7F7F7F'} />
        ) : (
