...
export const SeeAllJobs = ({ route, navigation }) => {
          ...
          <View style={tw`flex-row items-center`}>
            ...
            <View>
              ...
              <Text
                ...
                numberOfLines={1}
                ellipsizeMode="tail">
                Salary: {item?.salary} per {item?.salarybasis}
              </Text>
            </View>
          </View>
          <Text
            ...
            {`${item?.location?.city || "City - NA"} / ${item?.location?.state || "State - NA"}`}
          </Text>
        </View>
      ...
      <SafeAreaView style={tw`flex-1 bg-slate-50`} edges={['top']}>
        ...
        <View style={tw`flex-1 justify-center items-center p-5`}>
          <Text style={[tw`text-black text-lg mb-2`, { fontFamily: 'Poppins-Bold' }]}>
            No Jobs available for the selected categories
          </Text>
