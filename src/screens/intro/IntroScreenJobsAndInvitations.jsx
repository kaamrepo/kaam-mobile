        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={tw`flex-1`}>
                ...
                <View style={tw`w-full h-[40%] px-10 py-3 justify-between`}>
                    <View>
                        <Text style={[{ fontFamily: "Poppins-SemiBold" }, tw`text-black text-3xl py-2`]}>{translation[5][selectedLanguage]}</Text>
                        <Text style={[tw`py-2 text-sm text-gray-600`, { fontFamily: 'Poppins-Regular' }]}>{translation[10][selectedLanguage]}</Text>
                    </View>
